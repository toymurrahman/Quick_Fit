...
/> <br />
     ...
     <div  className="  flex-1 w-[500px] h-[700px] bg-green-900  text-white" 
        ...
        <p className='ml-16 mt-4'>toymur@gmail.com</p>
        <p className='ml-16'>   rahmantoymur2@gmail.com  </p>
        <h1 className='text-5xl text-primary ml-16 mt-16'>Address:</h1>
        <p className='ml-16 mt-4'>Brahmanbaria</p>
        <p className='ml-16 pb-16 lg:pb-0'>Bangladesh</p>
